...
_ROSMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='is.ros.ROSMessage.type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='content', full_name='is.ros.ROSMessage.content', index=1,
...
_ROSMESSAGE.fields_by_name['content'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
